...
* [Plutify](http://plutify.com/) - Plutify is a scalable Cloud Storage Space for store and serve client files beside variety of service like video sharing, file selling and, direct link and ... which uses Minio Object Storage in order to keep clients uploaded files.
