...
* [s3-resource-simple](https://github.com/making/s3-resource-simple) - s3-resource-simple is [Concourse CI](https://concourse.ci/) resource for uploading files to S3. It supports Minio as Object Storage backend. 
