...
* [Hephy Workflow](https://web.teamhephy.com/) - an [open source fork](https://github.com/teamhephy/workflow/) of Deis Workflow - The open source PaaS for [Kubernetes](https://kubernetes.io/). Workflow uses Minio by default to store all internal application metadata and database backups.
...
* [Nuage](https://github.com/mickael-kerjean/nuage) ([demo](https://nuage.kerjean.me/)) - A Dropbox-like interface for your existing data that supports Minio as one the backends.
